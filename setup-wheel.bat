@echo off
chcp 65001 >nul 2>&1
title report-skill setup (wheel)
cd /d "%~dp0"

echo.
echo ===============================================
echo   report-skill - one-shot installer (wheel)
echo ===============================================
echo.
echo   Prerequisite: Python 3.11+ from python.org
echo     ('Add python.exe to PATH' must be checked;
echo      the Microsoft Store python does NOT count)
echo.
...
echo.
echo   What this does:
echo     - creates a Python venv in this folder
echo     - pip-installs the bundled report-skill wheel
echo       (offline when wheels\ is shipped alongside)
